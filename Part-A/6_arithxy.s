...
# C Functions called : scanf, printf
...
# Execute the code arithxy generated using the following command :
#
# $ ./arithxy
# -----------------------------------------------------------------------------
.global _start
...
_start:
    ...
    # Parameters passed – printf format in %rdi and y value in %rsi
    movq $y, %rsi
    movq (%rsi), %rax
    pushq %rax
    pushq %rcx
